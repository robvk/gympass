![Preview of PizzaFromUs!](/client/src/assets/pizzaFromUs.GIF)

# Class 37 final project: PizzaFromUs

This is the final project for the HackYourFuture curriculum we did as a class using the MERN stack by following the agile methodology with our team and a group of mentors. A quick guide to what we built:

PizzaFromUs

"Do you love pizza and supporting non-profit organisations? Then PizzaFromUs is for you! Are you a non-profit and want to schedule events but the budget is tight, then add your event to our app and donators will be able to help pay for your pizzas! Donators know where their money is going to and non-profit organisations are able to have more events. A clear win-win!"

[Click here for the Demo version](https://c37-hyf-project.herokuapp.com)
